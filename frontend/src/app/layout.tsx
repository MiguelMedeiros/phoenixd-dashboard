...
// PWA Constants
const APP_NAME = 'Phoenixd Dashboard';
const APP_DEFAULT_TITLE = 'Phoenixd Dashboard';
const APP_TITLE_TEMPLATE = '%s | Phoenixd Dashboard';
const APP_DESCRIPTION = 'Lightning Node Management Dashboard for Phoenixd';
